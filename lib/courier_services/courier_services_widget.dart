            ...
            child: Column(
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 0.0, 16.0),
                    child: Text(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            const EdgeInsetsDirectional.fromSTEB(0.0, 0.0, 17.0, 0.0),
                        child: wrapWithModel(
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 42.0, 0.0, 13.0),
                    child: Text(
                ...
                Align(
                  ...
                  child: Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 42.0, 0.0, 4.0),
                    child: Text(
                      'Package Weight',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            fontFamily: 'Segoe UI',
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(8.0, 0.0, 8.0, 18.0),
                  child: SizedBox(
                    width: 355.0,
                    child: TextFormField(
