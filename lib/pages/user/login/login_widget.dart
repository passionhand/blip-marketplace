                              ...
                              if ((_model.loginResponse?.succeeded ?? true)) {
                                if (FFAppState().firstLogin) {
                                  ...
                                  context.pushNamedAuth(
                                      'TermsAndConditions', context.mounted);
                                } else {
                                  logFirebaseEvent('Button_navigate_to');
                          ...
                          child: Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'LOGIN_PAGE_Container_a03iui93_ON_TAP');
                                  ...
                                  if ((_model.loginResponseGoogle?.succeeded ??
                                      true)) {
                                    if (FFAppState().firstLogin) {
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'LOGIN_PAGE_Container_8oqbp78i_ON_TAP');
                                  logFirebaseEvent('Container_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                                  final user = await authManager
                                  ...
                                  if ((_model.loginResponseApple?.succeeded ??
                                      true)) {
                                    if (FFAppState().firstLogin) {
                                      logFirebaseEvent('Container_navigate_to');
