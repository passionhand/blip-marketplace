...
DocumentReference? get currentUserReference =>
    loggedIn ? BlipDevProject1Record.collection.doc(currentUser!.uid) : null;

BlipDevProject1Record? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : BlipDevProject1Record.getDocument(
                  BlipDevProject1Record.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
