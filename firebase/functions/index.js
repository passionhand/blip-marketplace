...
function getDocIdBound(index, numBatches) {
  ...
  return "BLIP_DEV_PROJECT1/" + firstChar + secondChar;
}
...
const kStripeTestSecretKey =
  "sk_test_51PYuPl2N6fpDJFaN1G2ihcnwqevPQ5VAB5ZZqldcX6kCU8vh8c0pcmrcJq11z18xF1tHf1xnC9CNuVIy99Ho3sAk003K2iVonh";
...
exports.onUserDeleted = functions.auth.user().onDelete(async (user) => {
  ...
  let userRef = firestore.doc("BLIP_DEV_PROJECT1/" + user.uid);
});
